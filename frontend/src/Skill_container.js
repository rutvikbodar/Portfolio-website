    ...
    return (
        <div className="alignSkills">
            <div className="center">
                ...
                <div id="hive_addons">
                    {isInitiated?<Skill_state skillName={skillObject.skillName} imagePath={skillObject.imagePath} proficiency={skillObject["proficiency"]} percentage={skillObject["MasteryLevel"]} numberOfProjects={skillObject["NumberOfProjects"]} opacity={0} id={skillObject.skillName}/>:<div className="skillWrapper"><div className="chooseSkillContainer"><img className="chooseSkillImage" src="chooseSkill.png"/></div></div>}
                </div>
            </div>
        </div>
    )
