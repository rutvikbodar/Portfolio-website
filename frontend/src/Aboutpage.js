        ...
        <div>
            <div className='aboutPage'>
                ...
                <div className='aboutDescription'>
                    <div className='introTitle' id='introTitleTag'>
                        Let me introduce my self
                    </div>
                    <div className='introContent' id='introContentTag'>
                    <p>
                    ...
                    <div className='introTitle' id='whyTitleTag'>Why would you care?</div>
                    <div className='introContent' id='whyContentTag'>
                        <p>
                        ...
                        <p>
                        Luckily, we have already overcome that problem. For instance, this project was started to be <span className='highlight'>build 1 months after my first search for "what is M.E.R.N." or 2 months after my search for "what is web-development" at all</span>.
                        </p>
